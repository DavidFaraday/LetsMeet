...
//  LetsMeet
//
//  Created by David Kababyan on 20/07/2020.
//
...
class ChatViewController: MessagesViewController {
    ...
    private func markMessageAsRead(_ messageDictionary: Dictionary<String, Any>) {
        ...
        if messageDictionary[kSENDERID] as! String != FUser.currentId() {
            OutgoingMessage.updateMessage(withId: messageDictionary[kID] as! String, chatRoomId: chatId, memberIds: [FUser.currentId(), recipientId])
        }
    }

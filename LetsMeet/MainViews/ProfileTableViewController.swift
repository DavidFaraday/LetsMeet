...
//  LetsMeet
//
//  Created by David Kababyan on 02/07/2020.
//
...
//    var genderOptions = ["Male", "Female"]
    ...
    private func changeEmail() {
        ...
        FirebaseUserListener.shared.updateUserEmail(newEmail: alertTextField.text!, completion: { (error) in
...
extension ProfileTableViewController : UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        lookingForTextField.text = Gender.allCases[row].rawValue
    }
